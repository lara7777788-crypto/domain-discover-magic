...
export const Route = createFileRoute("/login")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Sign in or create a Layercake account to save your slices, track your credits, and download every visual you bake." },
      { property: "og:title", content: "Sign in — Layercake" },
      { property: "og:description", content: "Sign in to your Layercake account to bake, save, remix, and download your AI-generated slices." },
      ...
      <div className="mx-auto flex min-h-screen max-w-md flex-col items-center justify-center px-6">
        ...
        <div className="mt-5 w-full rounded-3xl border border-pink-200 bg-pink-50/90 p-5 shadow-[0_20px_40px_-30px_rgba(236,72,153,0.6)] backdrop-blur">
          ...
          <p className="mt-1 text-xs text-pink-700/70">
            Got a code like SWxxxxx or HOxxxx? Drop it here — the slices land on your account as soon
            as you sign in. Case doesn't matter.
          </p>
