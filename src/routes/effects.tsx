...
const EFFECTS: Effect[] = [
  ...
  { key: "caramel", label: "Caramel", emoji: "🍯", swatch: "linear-gradient(135deg,#FFEBC2,#F0B košt)", hint: "Golden pour", prompt: "made of glossy pouring caramel and toffee with slow golden drips, warm light" },
